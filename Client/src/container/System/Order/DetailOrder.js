            ...
            <div className="wrap-order">
                ...
                <div className="wrap-payment">
                    ...
                    <div className="content-top" style={{ display: "flex", gap: "10px" }}>
                        ...
                        <div className="box-img-preview" style={{ backgroundImage: `url(https://lh4.googleusercontent.com/becnmXhPSWn72klWuQweC9bQi4-IPwJnLPM9lcZaMyZI4d-2Z0ZrJoJeugNQe7ZiiHJtZPqp1ErmSyT_TDDXxSTM4u0u4GQA6svVwxgsq1qQ4PC57H5N4-5paIgi9QPd6OQkeypZ)`, width: "200px", height: "200px", borderRadius: "10px" }}></div>
                    </div>

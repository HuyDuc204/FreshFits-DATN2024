        ...
        <div className="card-body">
          <form>
            <div className="form-row">
              ...
              <div className="form-group col-md-4">
                ...
                <input
                  ...
                  id="inputPassword4"
                />
                {errors.name && <p className="text-danger">{errors.madeby}</p>}
              </div>
            </div>
            <div className="form-row">
              ...
              <div className="form-group col-md-6">
                ...
                {errors.name && <p className="text-danger">{errors.brandId}</p>}
              </div>
            </div>
            <div className="form-group">
              ...
              />
              {errors.name && (
                <p className="text-danger">{errors.contenMarkdown}</p>
              )}
            </div>
            ...
            <div className="form-row">
              ...
              <div className="form-group col-md-4">
                ...
                <input
                  ...
                  id="inputEmail4"
                />
                {errors.name && <p className="text-danger">{errors.width}</p>}
              </div>
              <div className="form-group col-md-4">
                ...
                <input
                  ...
                  id="inputPassword4"
                />
                {errors.name && <p className="text-danger">{errors.height}</p>}
              </div>
              <div className="form-group col-md-4">
              ...
              <div className="form-group col-md-4">
                ...
                <input
                  ...
                  id="inputEmail4"
                />
                {errors.name && <p className="text-danger">{errors.weight}</p>}
              </div>
            </div>
            <div className="form-group">
            ...
            <div className="form-row">
              <div className="form-group col-md-4">
                ...
                {errors.name && <p className="text-danger">{errors.sizeId}</p>}
              </div>
              <div className="form-group col-md-4">

            ...
            <div style={{ width: props.width, height: props.height }} className="box-voucher">
                ...
                <div className="content-right">
                    <div className="box-content-right">
                        <span className="name-voucher">Mã {props.typeVoucher} VNĐ</span>
                        <span className="max-value-voucher">Giảm giá {CommonUtils.formatter.format(props.maxValue)} VNĐ</span>
